...
def self_test(request):
    ...
    INFORMATION = {
        ...
        (20, 29): "ความกลัวหรือกังวลส่งผลกระทบต่อหลายสถานการณ์หรือกิจกรรมในชีวิตประจำวัน คุณอาจหลีกเลี่ยงสถานการณ์บางอย่าง หรือมีความวิตกกังวลอย่างมากเมื่อเผชิญกับสิ่งที่กลั",
